      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-sky-800 via-sky-600 to-cyan-400 text-white">
        ...
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-14 sm:pt-20">
          <Reveal>
            ...
            <p className="mt-4 max-w-2xl text-sm font-medium leading-6 text-white sm:text-base">
              {t("home.guarantee")}
            </p>
            <AirlineLogos onDark />
          </Reveal>
            ...
            <Reveal key={d.slug} delayMs={i * 70}>
              ...
              >
                ...
                <p className="mt-3 text-sm font-semibold text-sky-800">
                  {t("dest.avgFare")} {formatPrice(d.avgFare)}
                </p>
                <p className="mt-1 text-xs font-medium text-orange-700">{t("stay.included")}</p>
              </Link>
            </Reveal>
          ))}
        </div>
