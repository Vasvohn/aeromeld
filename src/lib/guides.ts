    ...
    body: [
      {
        ...
        paragraphs: [
          ...
          "6. Réservez les lignes Caraïbes / Noël des mois à l’avance. 7. Évitez le last minute sur les îles. 8. Une alerte ne remplace pas un tarif déjà correct. 9. Même cabine (éco vs business) pour juger. 10. Ouvrez le partenaire officiel : le prix Aeromeld est une estimation de démo tant que l’API live n’est pas branchée, le réflexe de comparaison reste le bon.",
        ],
      },
      {
        heading: "Pinterest",
